<template>
    <div class="flex justify-center items-center h-screen p-8">
        <div class="w-[90%] bg-white shadow-md rounded-lg h-[90%] flex justify-start flex-col relative p-4">
            <h1 class="text-center text-3xl py-8 font-bold">Term & Condition</h1>
            <div class="flow-root">
